...
* **Open a Project Folder in VS Code**
  From inside the `my_project` directory, open the project in VS Code by running
  `code .`
...
1. From inside the `my_project` directory, open the project in VS Code by running
   `code .`. In the VS Code terminal, run `ls -R` to display the full
   directory structure.
